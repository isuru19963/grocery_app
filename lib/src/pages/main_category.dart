...
import '../elements/MainCategoryFieldCarouselWidget.dart';
import '../controllers/main_category_controller.dart';

class MainCategoryWidget extends StatefulWidget {
  final RouteArgument routeArgument;

  MainCategoryWidget({Key key, this.routeArgument}) : super(key: key);

  @override
  _CategoryWidgetState createState() => _CategoryWidgetState();
}

class _CategoryWidgetState extends StateMVC<MainCategoryWidget> {
  // TODO add layout in configuration file
  String layout = 'grid';

  MainCategoryController _con;

  _CategoryWidgetState() : super(MainCategoryController()) {
    _con = controller;
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              //   ),
              // ),
          MarketCarouselWidget(marketsList: _con.allMarkets, heroTag: 'home_top_markets'),
